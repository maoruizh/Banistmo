...
import static co.com.bancolombia.certification.mantenimiento.userinterfaces.Bancolombia.BTN_CONVERTIDOR_TASAS_INTERES;
...
public class ClickConvertidorTasasInteresTasks implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Click.on(BTN_CONVERTIDOR_TASAS_INTERES));
    }
}
