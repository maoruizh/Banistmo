...
import static co.com.bancolombia.certification.mantenimiento.questions.MensajeCreditosEnMoraDetalle.mensajeCreditosEnMoraDetalle;
...
public class creditosEnMoraDetalleStepdefinition {
    ...
    public void iValidateTheFollowingMessagesToTheListadoCreditosEnMoraDetalleScreen(List<ModelData> modelDataList) {
        theActorInTheSpotlight().should(seeThat(mensajeCreditosEnMoraDetalle(modelDataList.get(0))));
    }
